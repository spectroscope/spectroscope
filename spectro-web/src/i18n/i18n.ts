...
export const dict: Record<string, { de: string; en: string }> = {
  ...
  "lm.intro": { de: "Diese laufen komplett auf dieser Maschine. Kein Key, kein Konto, keine Cloud — der Download kommt direkt vom Herausgeber des Modells, und nichts, was du tippst, verlässt deinen Rechner.", en: "These run entirely on this machine. No key, no account, no cloud — the download comes straight from the model's publisher, and nothing you type leaves your computer." },
  ...
  "local.model.qwen3-4b.blurb": { de: "Der solide Mittelweg: denkt nach, ruft Tools auf und passt bequem in 8 GB Speicher.", en: "A solid middle ground: reasons, calls tools, and fits comfortably in 8 GB of memory." },
  "local.model.qwen2-5-coder-7b.goodFor": { de: "Code und Agenten-Arbeit mit Tools", en: "coding and tool-driven agent work" },
  "local.model.qwen2-5-coder-7b.blurb": { de: "Der Standard. Gebaut für Code und präzise Anweisungen, und der stärkste Tool-Aufrufer hier. Kein Denk-Kanal; es antwortet direkt.", en: "The default. Built for code and precise instructions, and the strongest tool caller here. No thinking channel; it answers directly." },
  ...
  "local.model.vibethinker-3b.licenceCaveat": { de: "Die Lizenz seines Basismodells erlaubt Forschungs- und Evaluationsnutzung; du lädst es selbst beim Herausgeber.", en: "Its base model's licence allows research and evaluation use; you download it yourself from its publisher." },
