...
export const dict: Record<string, { de: string; en: string }> = {
  ...
  "tr.buttonTitle": { de: "Die lesbaren Teile dieser Sitzung übersetzen", en: "Translate the readable parts of this session" },
  "tr.title": { de: "Übersetzung", en: "translation" },
  "tr.lede": { de: "Übersetzt, was in dieser Sitzung jemand geschrieben oder gelesen hat: deine Nachrichten und die Antworten. Tool-Aufrufe, Tool-Ausgaben, Dateipfade und Codeblöcke bleiben im Original. Die Sitzung selbst wird nicht verändert — das Original steht neben der Übersetzung.", en: "Translates what a person wrote or read in this session: your messages and the answers. Tool calls, tool output, file paths and code blocks stay in the original. The session itself is not changed — the original stays right next to the translation." },
  ...
  "tr.engine.cloud": { de: "der konfigurierte Anbieter", en: "the configured provider" },
  "tr.engine.cloud.body": { de: "Schneller und meist besser, und es kostet deinen Key. Die Textstellen verlassen diesen Rechner.", en: "Faster and usually better, and it spends your key. The passages leave this machine." },
  "tr.engine.choose": { de: "diesen nehmen", en: "use this one" },
  ...
  "tr.out.needsKey": { de: "Der konfigurierte Anbieter hat keinen Key.", en: "The configured provider has no key." },
  "tr.out.providerIsLocal": { de: "Der konfigurierte Anbieter IST das eingebaute Modell — in den Einstellungen einen Cloud-Anbieter wählen, oder lokal übersetzen.", en: "The configured provider is the built-in model — pick a cloud provider in Settings, or translate locally." },
  "tr.out.generic": { de: "In dieser Installation nicht verfügbar.", en: "Not available on this install." },
  "tr.enginesFailed": { de: "Der Server konnte nicht sagen, welche Engines verfügbar sind ({msg}).", en: "Could not ask the server which engines are available ({msg})." },
  ...
  "tr.nothing": { de: "In dieser Sitzung ist noch nichts Lesbares.", en: "Nothing readable in this session yet." },
  "tr.dropped": { de: "{n} weitere Textstellen sind nicht dabei — diese Sitzung ist länger als ein Übersetzungslauf.", en: "{n} further passages are not included — this session is longer than one translation run." },
  ...
  "tr.failedPassage": { de: "Diese Textstelle wurde nicht übersetzt: {msg}", en: "This passage did not translate: {msg}" },
  ...
  "tr.applied": { de: "Die Übersetzung landet in allen Ansichten dieser Sitzung auf einmal — Chat, Trace, Text-Feed und Lab lesen denselben Strom.", en: "The translation lands in every view of this session at once — chat, trace, text feed and lab all read the same stream." },
