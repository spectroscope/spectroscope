...
export const dict: Record<string, { de: string; en: string }> = {
  ...
  // Card 223 hedged this with "(configured)" while a running session could hold a tier the
  // row could not see. Card 222 landed and web_search now resolves per call, so the configured
  ...
  "ws.closeFile": { de: "Datei schließen", en: "close file" },
  "ws.closeAll": { de: "alle schließen", en: "close all" },
  "ws.rendered": { de: "gerendert", en: "rendered" },
  "ws.source": { de: "Quelltext", en: "source" },
  "ws.foldRegion": { de: "Bereich ein-/ausklappen", en: "fold or unfold this region" },
  "ws.foldedLines": { de: "{n} Zeilen eingeklappt", en: "{n} lines folded" },
  ...
  "map.station.shared": { de: "Mehrere Agenten sind gerade an dieser Station", en: "Several agents are on this station right now" },
