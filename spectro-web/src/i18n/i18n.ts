...
export const dict: Record<string, { de: string; en: string }> = {
  ...
  "set.sttHint": { de: "Zwei Dinge werden gebraucht: das Whisper-Modell, das diese App laden kann, und whisper-cli, das sie NICHT installieren darf — es wird gesucht und ehrlich gemeldet.", en: "Two things are needed: the whisper model, which this app can fetch, and whisper-cli, which it must NOT install — that one is probed and reported honestly." },
