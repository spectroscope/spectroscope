...
export const dict: Record<string, { de: string; en: string }> = {
  ...
  // control room — the three columns and the ledger strip
  "fleet.eyebrow": { de: "flotte", en: "fleet" },
  "fleet.ledgerAria": { de: "Was die Flotte verbraucht hat", en: "What the fleet spent" },
  "fleet.rolesAria": { de: "Verbrauch je Rolle", en: "Spend per role" },
  "fleet.role.tok": { de: "tok", en: "tok" },
  "fleet.stat.wall": { de: "wanduhr", en: "wall clock" },
  "fleet.stat.wall.title": { de: "Von der ersten bis zur letzten Handlung irgendeines Knotens.", en: "From the first act of any node to the last." },
  "fleet.stat.agentTime": { de: "agentenzeit", en: "agent time" },
  "fleet.stat.agentTime.title": { de: "Die Spannen aller Agenten addiert, und wie oft das in die Wanduhr passt: der Faktor IST die Parallelität. Nur die Wanduhr sagt, wie lange die Flotte gebraucht hat.", en: "The agents' own spans added up, and how many times that fits into the wall clock: the factor IS the parallelism. Only the wall clock says how long the fleet took." },
  "fleet.stat.tokens": { de: "tokens rein / raus", en: "tokens in / out" },
  "fleet.stat.tokens.title": { de: "Tokens, keine Kosten — auf der Leitung steht kein Preis, also wird hier keiner behauptet.", en: "Tokens, not cost: no price rides the wire, so none is claimed here." },
  "fleet.stat.tools": { de: "tools · laufzeit", en: "tools · runtime" },
  "fleet.stat.tools.title": { de: "Aufrufe und ihre reine Ausführungszeit — die Gate-Wartezeit steckt nicht darin.", en: "Calls and their pure execution time; gate wait is not in it." },
  "fleet.stat.gates": { de: "gates · wartezeit", en: "gates · wait" },
  "fleet.stat.gates.title": { de: "Wie lange Aufrufe am Permission-Gate geparkt haben — vom Server gemessen (gateWaitMs).", en: "How long calls sat parked at the permission gate, as the server measured it (gateWaitMs)." },
  "fleet.stat.gates.titleFloor": { de: "Untergrenze: mindestens ein Gate kam ohne Messung zurück, die echte Wartezeit ist höher.", en: "A floor: at least one gate came back without a measurement, so the real wait is higher." },
  "fleet.stat.errors": { de: "fehler", en: "errors" },
  "fleet.stat.errors.title": { de: "Fehler-Events plus fehlgeschlagene Tool-Aufrufe.", en: "Error events plus failed tool calls." },
  "fleet.tree": { de: "agenten", en: "agents" },
  "fleet.treeAria": { de: "Agenten-Baum der Flotte", en: "The fleet's agent tree" },
  "fleet.tree.empty": { de: "Noch kein Agent.", en: "No agent yet." },
  "fleet.gateShort": { de: "gate", en: "gate" },
  "fleet.gatePending": { de: "Wartet auf eine Permission-Entscheidung", en: "Waiting for a permission decision" },
  "fleet.detailAria": { de: "Detail zur Auswahl", en: "Detail for the selection" },
  "fleet.detail.fleetTitle": { de: "die flotte", en: "the fleet" },
  "fleet.detail.close": { de: "Auswahl aufheben", en: "Clear the selection" },
  "fleet.detail.pick": { de: "Wähle einen Agenten im Baum oder auf der Canvas — sein Detail erscheint hier.", en: "Pick an agent in the tree or on the canvas and its detail appears here." },
  "fleet.detail.empty": { de: "Diese Flotte hat noch keine Knoten. Eine Flotte ist mehrere Agenten, die du zusammen beobachtest.", en: "This fleet has no nodes yet. A fleet is several agents you watch together." },
  "fleet.detail.byRole": { de: "je rolle", en: "per role" },
  "fleet.detail.startNode": { de: "einen node starten (terminal)", en: "start a node (terminal)" },
  "fleet.detail.spawn": { de: "node starten (read-only)", en: "spawn a node (read-only)" },
  "fleet.detail.trigger": { de: "trigger", en: "trigger" },
  "fleet.detail.capabilities": { de: "werkzeuge", en: "tools" },
  "fleet.detail.openTrace": { de: "im trace öffnen", en: "open in trace" },
  "fleet.detail.stop": { de: "node stoppen", en: "stop node" },
  "fleet.detail.recent": { de: "letzte {n} von {total} events", en: "last {n} of {total} events" },
  "fleet.detail.noEvents": { de: "Dieser Agent hat noch nichts gesendet.", en: "This agent has sent nothing yet." },
  "fleet.detail.openEvent": { de: "Dieses Event im Trace öffnen", en: "Open this event in the trace" },
  "fleet.col.role": { de: "rolle", en: "role" },
  "fleet.col.tokens": { de: "tokens", en: "tokens" },
  "fleet.col.cache": { de: "cache gelesen / geschrieben", en: "cache read / written" },
  "fleet.col.cache.title": { de: "Prompt-Caching: gelesene und neu angelegte Tokens. Sie zählen nicht in tokens rein.", en: "Prompt caching: tokens read and tokens newly written. They are not part of tokens in." },
  "fleet.col.tools": { de: "tools", en: "tools" },
  "fleet.col.gates": { de: "gates", en: "gates" },
  "fleet.col.span": { de: "spanne", en: "span" },
  "fleet.col.span.title": { de: "Von der ersten bis zur letzten Handlung dieses Agenten.", en: "From this agent's first act to its last." },
