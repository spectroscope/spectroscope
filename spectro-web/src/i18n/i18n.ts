...
export const dict: Record<string, { de: string; en: string }> = {
  ...
  "leveling.criterion.providerReady.counts": { de: "Ein Provider meldet sich bereit, oder ein Lauf kommt durch.", en: "A provider reports ready, or a run comes back." },
  "leveling.criterion.firstRunComplete.label": { de: "Erster Lauf", en: "first run" },
  "leveling.criterion.firstRunComplete.counts": { de: "Ein Lauf in diesem Zuhause endet ohne Abbruch.", en: "A run in this home ends without breaking off." },
  ...
  "leveling.criterion.traceOpened.counts": { de: "Den Trace einer Session ansehen, die ein Tool aufgerufen hat.", en: "View the trace of a session that called a tool." },
  ...
  "leveling.criterion.otlpProbeGreen.counts": { de: "Der Doctor erreicht den konfigurierten OTLP-Endpunkt.", en: "The doctor reaches the configured OTLP endpoint." },
