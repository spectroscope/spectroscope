...
public final class ExchangeLatency {
    ...
    /**
     * How many exchanges have been measured — the honesty half of {@link #p50Ms}:
     * a median over one sample is a sample.
     *
     * @return the number of observations, counting past the window's own length
     */
